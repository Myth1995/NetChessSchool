    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
            ...
            <ul class="navbar-nav">
                ...
                @endif
                @if(Auth()->check() && Auth()->user()->sponser_id == null)
                    <li class="nav-item"><a class="nav-link js-scroll {{ $route_name == 'mlm.join' ? 'active' : '' }}" href="{{route('mlm.join', Session::has('request_sponser') ? Session::has('request_sponser') : "Info@Networkchessschool.Com" )}}">JOIN AS PARTNER</a></li>
                @endif
                @if(Auth()->check())
